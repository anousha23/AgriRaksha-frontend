  ...
  const items = [
    {
      title: "Upload",
      route: "/upload",
      icon: <img src={upload} alt="Upload" className="w-[40vw] md:w-[32vw] lg:w-[20vw]" />,
      color: "bg-[#a8bfa2]",
    ...
    {
      title: "Smart Nudge",
      icon: <img src={snudge} alt="Smart Nudge" className="w-[25vw] md:w-[14vw] lg:w-[3vw]" />,
      color: "bg-[#d6c15c]",
      className: "col-span-1",
    },
    {
      title: "Gov Schemes",
      icon: <img src={gov} alt="Gov Schemes" className="w-[25vw] md:w-[14vw] lg:w-[3vw]" />,
      color: "bg-[#f1ede4]",
      className: "col-span-1",
    },
    {
      title: "Online Store",
      icon: <img src={store} alt="Online Store" className="w-[40vw] md:w-[20vw] lg:w-[3vw]" />,
      color: "bg-[#a08e7a]",
      className: "col-span-2",
    },
    {
      title: "Knowledge Hub",
      icon: <img src={hub} alt="Knowledge Hub" className="w-[30vw] md:w-[18vw] lg:w-[3vw]" />,
      color: "bg-[#9bb382]",
      className: "col-span-2",
    },
  ];
